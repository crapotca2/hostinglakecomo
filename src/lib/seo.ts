...
// Branded OG preview shown when a Host Como link is shared on WhatsApp /
// Telegram / Slack / Facebook etc. Generated by scripts/generate-og-image.mjs
// (white logo over como-trama texture with navy overlay — same visual
// language as the favicon and the footer).
