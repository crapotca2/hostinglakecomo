...
function label(key: string, locale: SupportedLocale): string {
  const labels: Record<string, Partial<Record<SupportedLocale, string>>> = {
    walkable: { it: "I più vicini", en: "Closest to you", ru: "Самые ближние", de: "Am nächsten", pl: "Najbliżej Ciebie", es: "Los más cercanos", fr: "Les plus proches" },
    atmBanking: { it: "Bancomat & banche", en: "ATMs & banks", ru: "Банкоматы и банки", de: "Geldautomaten & Banken", pl: "Bankomaty i banki" },
    shopping: { it: "Supermercati zona", en: "Supermarkets nearby", ru: "Супермаркеты", de: "Supermärkte", pl: "Supermarkety w okolicy" },
    eatingDrinking: { it: "Ristoranti e bar", en: "Restaurants & bars", ru: "Рестораны и бары", de: "Restaurants & Bars", pl: "Restauracje i bary" },
    boatRentals: { it: "Noleggio barche", en: "Boat rentals", ru: "Аренда лодок", de: "Bootsverleih", pl: "Wypożyczalnia łodzi" },
    boatTours: { it: "Tour con skipper", en: "Skippered tours", ru: "Туры со шкипером", de: "Touren mit Skipper", pl: "Rejsy ze sternikiem" },
    bikeRentals: { it: "Noleggio bici", en: "Bike rentals", ru: "Аренда велосипедов", de: "Fahrradverleih", pl: "Wypożyczalnia rowerów" },
    activeOutdoor: { it: "Outdoor & sport", en: "Outdoor & sports", ru: "Активный отдых", de: "Outdoor & Sport", pl: "Outdoor i sport" },
    dayTrips: { it: "Mete in barca o bus", en: "By boat or bus", ru: "На лодке или автобусе", de: "Mit Boot oder Bus", pl: "Wycieczki łodzią lub autobusem" },
    drivingTrips: { it: "Mete in auto", en: "Driving trips", ru: "Поездки на машине", de: "Autoausflüge", pl: "Wycieczki samochodem" },
    ...
    pharmaciesNote: {
      ...
      pl: "Dyżury aptek zmieniają się co tydzień. Aby dowiedzieć się, która apteka pełni dyżur TERAZ, zadzwoń pod numer 1240 (bezpłatnie, 24/7).",
    },
    groupNearby: { it: "Vicino a casa", en: "Close to home", ru: "Рядом с домом", de: "In der Nähe", pl: "Blisko domu", es: "Cerca de casa", fr: "Près de chez vous" },
    groupActivities: { it: "Cibo, sport e noleggi", en: "Food, sport & rentals", ru: "Еда, спорт и аренда", de: "Essen, Sport & Verleih", pl: "Jedzenie, sport i wypożyczalnie", es: "Comida, deporte y alquileres", fr: "Restauration, sport & locations" },
    groupExplore: { it: "Esplora il Lago", en: "Explore the lake", ru: "Исследуйте озеро", de: "Erkunden Sie den See", pl: "Odkryj jezioro", es: "Explora el lago", fr: "Explorez le lac" },
    min: { it: "min", en: "min", ru: "мин", de: "Min", pl: "min" },
    minWalk: { it: "min a piedi", en: "min walk", ru: "мин пешком", de: "Min zu Fuß", pl: "min pieszo" },
    getDirections: { it: "Indicazioni", en: "Directions", ru: "Маршрут", de: "Wegbeschreibung", pl: "Trasa" },
    openInMaps: { it: "Apri Maps", en: "Open Maps", ru: "Открыть карту", de: "In Maps öffnen", pl: "Otwórz Mapy", es: "Abrir Maps", fr: "Ouvrir Maps" },
    bestTime: { it: "Quando andarci", en: "Best time", ru: "Лучшее время", de: "Beste Zeit", pl: "Kiedy się wybrać", es: "Mejor momento", fr: "Meilleur moment" },
    scanForDirections: { it: "Inquadra per le indicazioni", en: "Scan for directions", ru: "Отсканируйте для маршрута", de: "Scannen für Wegbeschreibung", pl: "Zeskanuj, aby uzyskać trasę" },
    scanShort: { it: "Inquadra", en: "Scan", ru: "Скан", de: "Scan", pl: "Zeskanuj", es: "Escanea", fr: "Scanne" },
    moreInfo: { it: "Altre info", en: "More info", ru: "Подробнее", de: "Mehr Infos", pl: "Więcej informacji", es: "Más info", fr: "Plus d'infos" },
    call: { it: "Chiama", en: "Call", ru: "Позвонить", de: "Anrufen", pl: "Zadzwoń", es: "Llamar", fr: "Appeler" },
    scanToOpen: { it: "Inquadra per aprire", en: "Scan to open", ru: "Отсканируйте, чтобы открыть", de: "Zum Öffnen scannen", pl: "Zeskanuj, aby otworzyć" },
    officialSite: { it: "Sito ufficiale", en: "Official site", ru: "Офиц. сайт", de: "Offizielle Seite", pl: "Oficjalna strona", es: "Sitio oficial", fr: "Site officiel" },
    destination: { it: "Destinazione", en: "Destination", ru: "Назначение", de: "Ziel", pl: "Cel", es: "Destino", fr: "Destination" },
    time: { it: "Tempo", en: "Time", ru: "Время", de: "Zeit", pl: "Czas", es: "Tiempo", fr: "Durée" },
    price: { it: "Prezzo", en: "Price", ru: "Цена", de: "Preis", pl: "Cena", es: "Precio", fr: "Prix" },
    roundTrip: { it: "a/r", en: "round trip", ru: "туда-обратно", de: "Hin & Zurück", pl: "w obie strony", es: "i/v", fr: "a/r" },
    topChoice: { it: "Top", en: "Top", ru: "Топ", de: "Top", pl: "Top" },
    phName: { it: "Farmacia", en: "Pharmacy", ru: "Аптека", de: "Apotheke", pl: "Apteka" },
    phDistance: { it: "Distanza", en: "Distance", ru: "Расстояние", de: "Entfernung", pl: "Odległość" },
    phPhone: { it: "Tel.", en: "Phone", ru: "Тел.", de: "Tel.", pl: "Tel." },
    "type-supermarket": { it: "Alimentari", en: "Groceries", ru: "Продукты", de: "Lebensmittel", pl: "Spożywczy" },
    "type-pharmacy": { it: "Farmacia", en: "Pharmacy", ru: "Аптека", de: "Apotheke", pl: "Apteka" },
    "type-atm": { it: "Banca / ATM", en: "Bank / ATM", ru: "Банк / ATM", de: "Bank / ATM", pl: "Bank / ATM" },
    "type-post": { it: "Posta", en: "Post office", ru: "Почта", de: "Post", pl: "Poczta" },
    "type-bakery": { it: "Forno", en: "Bakery", ru: "Пекарня", de: "Bäckerei", pl: "Piekarnia" },
    "type-outdoor": { it: "Outdoor", en: "Outdoor", ru: "Активный отдых", de: "Outdoor", pl: "Outdoor" },
    "type-bar": { it: "Bar", en: "Bar", ru: "Бар", de: "Bar", pl: "Bar" },
    "type-restaurant": { it: "Ristorante", en: "Restaurant", ru: "Ресторан", de: "Restaurant", pl: "Restauracja" },
    "type-newsstand": { it: "Edicola", en: "Newsstand", ru: "Газетный киоск", de: "Kiosk", pl: "Kiosk" },
    "type-ferry": { it: "Traghetto", en: "Ferry", ru: "Паром", de: "Fähre", pl: "Prom" },
    "type-bus": { it: "Autobus", en: "Bus", ru: "Автобус", de: "Bus", pl: "Autobus" },
    "type-funicular": { it: "Funivia", en: "Cable car", ru: "Фуникулёр", de: "Seilbahn", pl: "Kolejka linowa" },
    "type-boat-rental": { it: "Noleggio barche", en: "Boat rental", ru: "Аренда лодок", de: "Bootsverleih", pl: "Wypożyczalnia łodzi" },
    "type-bike-rental": { it: "Noleggio bici", en: "Bike rental", ru: "Аренда велосипедов", de: "Fahrradverleih", pl: "Wypożyczalnia rowerów" },
    tripadvisorRestaurantsTitle: {
      ...
      pl: "Restauracje w okolicy na TripAdvisor",
    },
    tripadvisorRestaurantsSubtitle: {
      ...
      pl: "Zobacz wszystkie opinie, zdjęcia i aktualne rankingi. Zeskanuj kod QR, aby otworzyć stronę na smartfonie.",
    },
  };
