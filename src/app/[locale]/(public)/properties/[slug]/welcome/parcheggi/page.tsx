...
const LABELS: Record<string, Partial<Record<SupportedLocale, string>>> = {
  ...
  publicParkingArgegno: {
    ...
    pl: "Parkingi publiczne w Argegno",
  ...
  privateDescription: {
    ...
    pl: "Prywatne miejsce parkingowe domu z windą samochodową. Opłata wynosi €10 za noc dla gości, którzy chcą zostawić zaparkowany samochód. Bezpłatny wjazd jest możliwy w celu rozładunku zakupów i bagażu bez dłuższego postoju.",
  ...
  condoRules: {
    ...
    pl: "Zasady wspólnoty: NIE wolno zostawiać zaparkowanego samochodu na górnych miejscach wspólnoty. Wyłącznie krótki załadunek/rozładunek. Na dłuższy postój należy korzystać z miejsca parkingowego domu z windą samochodową.",
  ...
  appWebsite: { it: "Sito operatore", en: "Operator site", ru: "Сайт оператора", de: "Anbieter-Website", pl: "Strona operatora", es: "Sitio del operador", fr: "Site de l'opérateur" },
  noEvCharging: {
    ...
    pl: "UWAGA: ładowanie pojazdów elektrycznych NIE jest dozwolone na tym prywatnym miejscu parkingowym domu.",
  ...
  scanShort: { it: "INQUADRA", en: "SCAN", ru: "СКАНИРУЙ", de: "SCANNEN", pl: "ZESKANUJ", es: "ESCANEA", fr: "SCANNEZ" },
  scanAriaParking: {
    ...
    pl: "Zeskanuj, aby uzyskać trasę do parkingu",
  ...
  scanAriaEv: {
    ...
    pl: "Zeskanuj, aby uzyskać trasę do stacji EV",
    es: "Escanea para la ruta a la estación EV",
    fr: "Scannez pour l'itinéraire vers la borne EV",
  },
  min: { it: "min", en: "min", ru: "мин", de: "Min", pl: "min", es: "min", fr: "min" },
  free: { it: "Gratis", en: "Free", ru: "Бесплатно", de: "Kostenlos", pl: "Bezpłatnie", es: "Gratis", fr: "Gratuit" },
  paid: { it: "A pagamento", en: "Paid", ru: "Платно", de: "Kostenpflichtig", pl: "Płatne", es: "De pago", fr: "Payant" },
  moreInfo: { it: "Maggiori info", en: "More info", ru: "Подробнее", de: "Mehr Infos", pl: "Więcej informacji", es: "Más info", fr: "Plus d'infos" },
  maxDimensions: { it: "Dimensioni massime ascensore", en: "Max lift dimensions", ru: "Макс. размеры лифта", de: "Max. Aufzugmaße", pl: "Maks. wymiary windy", es: "Dimensiones máx. ascensor", fr: "Dimensions max. ascenseur" },
  freePaid: { it: "gratis / a pagamento", en: "free / paid", ru: "бесплатно / платно", de: "kostenlos / kostenpflichtig", pl: "bezpłatnie / płatne", es: "gratis / de pago", fr: "gratuit / payant" },
  perKw: { it: "fast charge / standard", en: "fast charge / standard", ru: "быстрая / стандарт", de: "Schnell / Standard", pl: "szybkie / standardowe", es: "rápida / estándar", fr: "rapide / standard" },
  parkingOptionsAria: {
  ...
  evIntro: {
    ...
    pl: "Najbliższe domu stacje ładowania EV. Zeskanuj kod QR, aby uzyskać trasę z Aqua Vista do wybranej stacji ładowania.",
