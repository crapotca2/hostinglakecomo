...
const LABELS: Record<string, Partial<Record<SupportedLocale, string>>> = {
  ...
  practical: { it: "Info pratiche", en: "Practical info", ru: "Полезная информация", de: "Praktisches", pl: "Informacje praktyczne", es: "Info práctica", fr: "Infos pratiques" },
  ...
  checkout: { it: "Check-out", en: "Check-out", ru: "Выезд", de: "Check-out", pl: "Wymeldowanie", es: "Check-out", fr: "Check-out" },
  emergencies: { it: "Contatti di emergenza", en: "Emergency contacts", ru: "Экстренные контакты", de: "Notfallkontakte", pl: "Kontakty alarmowe", es: "Contactos de emergencia", fr: "Contacts d'urgence" },
  pharmacies: { it: "Farmacie vicine", en: "Nearby pharmacies", ru: "Ближайшие аптеки", de: "Nahe Apotheken", pl: "Apteki w pobliżu", es: "Farmacias cercanas", fr: "Pharmacies proches" },
  perPersonPerNight: { it: "persona / notte", en: "person / night", ru: "чел. / ночь", de: "Pers. / Nacht", pl: "osoba / noc", es: "persona / noche", fr: "personne / nuit" },
  groupRules: { it: "Pagamenti e regole", en: "Payments & rules", ru: "Оплата и правила", de: "Zahlungen & Regeln", pl: "Płatności i zasady", es: "Pagos y reglas", fr: "Paiements & règles" },
  groupHome: { it: "Vivere la casa", en: "Living in the house", ru: "Жизнь в доме", de: "Im Haus leben", pl: "Życie w domu", es: "Vivir la casa", fr: "Vivre la maison" },
  groupSafety: { it: "Emergenze, farmacie e Host Como", en: "Emergencies, pharmacies & Host Como", ru: "Экстренные службы, аптеки и Host Como", de: "Notfälle, Apotheken & Host Como", pl: "Nagłe wypadki, apteki i Host Como", es: "Emergencias, farmacias y Host Como", fr: "Urgences, pharmacies & Host Como" },
  hostComo: { it: "Contattaci", en: "Contact us", ru: "Связаться", de: "Kontakt", pl: "Skontaktuj się z nami", es: "Contáctenos", fr: "Contactez-nous" },
  hostComoTagline: { it: "Risposta 8-23", en: "Reply 8 AM - 11 PM", ru: "Ответ 8:00 — 23:00", de: "Antwort 8-23 Uhr", pl: "Odpowiedź 8-23", es: "Respuesta 8-23 h", fr: "Réponse 8h-23h" },
  call: { it: "Chiama", en: "Call", ru: "Позвонить", de: "Anrufen", pl: "Zadzwoń", es: "Llamar", fr: "Appeler" },
  website: { it: "Sito web", en: "Website", ru: "Сайт", de: "Website", pl: "Strona internetowa", es: "Sitio web", fr: "Site web" },
};
