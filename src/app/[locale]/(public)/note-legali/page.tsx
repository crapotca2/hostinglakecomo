...
export const metadata: Metadata = {
  title: "Note Legali",
  description:
    "Informazioni identificative del gestore del sito Como Host ai sensi del D.Lgs. 70/2003 in materia di commercio elettronico.",
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          ...
          <section className="space-y-4">
            ...
            <p className="text-base leading-relaxed text-muted-foreground">
              ...
              nell&apos;ambito dell&apos;attività di co-hosting e gestione di affitti
              brevi sul Lago di Como. Trattandosi di un&apos;attività gestita da
              persona fisica e non da societa di capitali, non sussistono
              ragione sociale, partita IVA, codice REA, sede legale né PEC
          ...
          <section className="space-y-4">
            ...
            <p className="text-base leading-relaxed text-muted-foreground">
              ...
              e ai Servizi è possibile utilizzare i seguenti recapiti:
              indirizzo email{" "}
              <a
          ...
          <section className="space-y-4">
            ...
            <p className="text-base leading-relaxed text-muted-foreground">
              ...
              Encrypt. L&apos;autenticazione degli utenti dell&apos;area clienti è
          ...
          <section className="space-y-4">
            ...
            <p className="text-base leading-relaxed text-muted-foreground">
              I marchi &quot;Host Como&quot; e &quot;Como Host&quot;, il logo, il wordmark &quot;como&quot; e
              ...
              d&apos;autore e proprietà industriale. Le fotografie delle
              proprietà gestite sono pubblicate con autorizzazione dei rispettivi
              proprietari, ai quali resta in capo la titolarità degli scatti.
              Eventuali contenuti di terze parti (loghi di Airbnb,
              Booking.com, Expedia, Google e altri partner) sono utilizzati a
              fini puramente identificativi e restano di proprietà dei
              rispettivi titolari.
            </p>
          </section>

          <section className="space-y-4">
            <h2 className="text-xl font-semibold">5. Natura dei servizi e limitazione di responsabilità</h2>
            <p className="text-base leading-relaxed text-muted-foreground">
              ...
              diretta: le prenotazioni di soggiorno presso le proprietà gestite
