"""
Genera il contratto Host Como v3 per Andrea Furlan + Ephanie Sacramento
(co-Mandanti in solido) sull'immobile Via della Libertà 7, Cernobbio.

Layout ricalca il PDF finale (17 articoli + 4 allegati). Adattamenti per
comunione ex art. 1108 c.c.:
 - Doppia identificazione anagrafica in intestazione
 - Premessa A-bis sulla comunione
 - Sostituzione "il Mandante" -> "i Mandanti" nei punti chiave
 - Nuovo comma art. 4.4 (IBAN unico designato)
 - Adempimenti fiscali pro-quota (art. 3.2 lett. c)
 - Doppia firma di Andrea + Ephanie in 3 sedi

I campi non ancora disponibili sono lasciati come "XXX" con
evidenziatore giallo per la revisione finale.
"""
...
MANDANTE2 = {
    ...
    "cf": "XXX",  # DA COMPLETARE — CF italiano da verificare
    "pec": "XXX",  # DA COMPLETARE — email o PEC
}
MANDATARIO = {
    ...
    "cf": "TLRNGL63L24C933I",
    "domicilio": "XXX",  # DA COMPLETARE — indirizzo/residenza di Angelo
    "piva": "04157560139",
    "ateco": "68.32.00",
...
OUTPUT = Path(r"C:/Users/Andrei/Desktop/Contratto_HostComo_Furlan_v3.docx")
...
p(doc,
  ...
  f'residente in {MANDANTE1["residenza"]}, C.F. {MANDANTE1["cf"]}; recapito PEC {MANDANTE1["pec"]} '
...
p(doc,
  ...
  f'residente in {MANDANTE2["residenza"]}, C.F. italiano {MANDANTE2["cf"]}; recapito email/PEC {MANDANTE2["pec"]} '
  '(di seguito, il "Mandante 2");')

p(doc,
  'Il Mandante 1 e il Mandante 2, di seguito congiuntamente denominati "i Mandanti", '
  'sottoscrivono il presente Contratto in solido tra loro ai sensi degli artt. 1292 e ss. c.c., '
  'in qualità di comproprietari dell\'Immobile come infra definito;')
...
# NUOVA PREMESSA A-bis: COMUNIONE
p(doc,
  'A-bis. L\'Immobile è in comunione tra Andrea Furlan (residente in Italia) ed Ephanie Sacramento (residente '
  'in Svizzera), i quali agiscono congiuntamente e in solido nei confronti del Mandatario ai sensi del presente '
  'Contratto. Ogni comunicazione, autorizzazione o istruzione al Mandatario proveniente anche solo da uno dei '
  'Mandanti è opponibile e vincolante nei confronti dell\'altro, fatti salvi gli atti eccedenti l\'ordinaria '
  'amministrazione della cosa comune ai sensi dell\'art. 1108 c.c. per i quali è richiesto il consenso scritto '
  'di entrambi i Mandanti. Le Parti danno reciprocamente atto che il Mandante 1 (Andrea Furlan) è designato '
  'quale referente operativo principale per le comunicazioni ordinarie con il Mandatario, ferma restando la '
  'responsabilità solidale del Mandante 2 (Ephanie Sacramento) per tutte le obbligazioni derivanti dal presente '
  'Contratto.')
...
# NUOVO comma su IBAN unico
p(doc,
  "4.4. I pagamenti effettuati dagli Ospiti affluiscono direttamente sul conto bancario designato dai Mandanti, "
  "comunicato all'OTA al momento della configurazione dell'Account. Considerato che gli OTA supportano un unico "
  "IBAN per Account, i Mandanti designano ai fini del presente Contratto un unico IBAN di riferimento per gli "
  "accrediti, intestato al Mandante 1 (Andrea Furlan) presso banca italiana; l'IBAN designato è comunicato al "
  "Mandatario in Allegato E ovvero in atto separato di designazione firmato da entrambi i Mandanti. Il riparto "
  "pro-quota degli incassi tra i comproprietari (compresi eventuali bonifici periodici dal Mandante 1 al "
  "Mandante 2 in Svizzera) avviene su base interna tra i Mandanti stessi ed è estraneo al perimetro del "
  "presente Contratto. Il Mandatario non riceve né detiene somme spettanti ai Mandanti in relazione alle Quote "
  "di Pernottamento e, conseguentemente, non opera in qualità di sostituto d'imposta ai sensi dell'art. 4, c. "
  "5-bis del D.L. 50/2017 conv. L. 96/2017. I Mandanti restano ciascuno unico responsabile pro-quota della "
  "corretta dichiarazione e versamento delle imposte sui canoni di locazione.")
...
set_run_font(r2)
p(doc, "(barrare la casella pertinente — nel presente Contratto entrambi i Mandanti agiscono quali consumatori).")

p(doc,
  "Le Parti danno reciprocamente atto che, considerato che entrambi i Mandanti agiscono in qualità di "
  "consumatori, le clausole eventualmente vessatorie restano soggette alla disciplina inderogabile di cui agli "
  "artt. 33-36 del Codice del Consumo, che prevale sull'accettazione specifica ex artt. 1341-1342 c.c.; resta "
  "fermo il foro inderogabile del consumatore di cui all'art. 17.3.")
...
p(doc, f'Recapiti del Mandante 1 (Andrea Furlan): PEC {MANDANTE1["pec"]}; indirizzo {MANDANTE1["residenza"]}.')
p(doc, f'Recapiti del Mandante 2 (Ephanie Sacramento): email/PEC {MANDANTE2["pec"]}; indirizzo {MANDANTE2["residenza"]}.')
p(doc, f'Recapiti del Mandatario: PEC {MANDATARIO["pec"]}; domicilio fiscale {MANDATARIO["domicilio"]}.')
...
p(doc,
  ...
  "Contratto, i Mandanti sono con-Titolari del trattamento ai sensi dell'art. 26 GDPR; il Mandatario è "
  "Responsabile del trattamento ai sensi dell'art. 28 GDPR, in quanto tratta i dati per conto dei Mandanti "
  "nell'ambito dei Servizi, avvalendosi di sub-responsabili ai sensi dell'art. 28.2 GDPR secondo quanto "
  "previsto nell'Allegato D. Il Mandante 1 (Andrea Furlan) è designato punto di contatto unico per le "
  "richieste degli interessati e per il rapporto con l'autorità di controllo, ferma restando la responsabilità "
  "congiunta di entrambi i Mandanti.")
...
p(doc, "Luogo e data: XXX, lì XX/XX/2026")
...
p(doc,
  "Ai sensi e per gli effetti degli artt. 1341 e 1342 c.c. — e ferma, considerato che entrambi i Mandanti "
  "agiscono in qualità di consumatori, la disciplina inderogabile di cui all'art. 5.3 — i Mandanti dichiarano "
  "di approvare specificamente, previa attenta lettura, le seguenti clausole: art. 2.2 (esclusione dell'art. "
  "1661 c.c. e facoltà di rifiuto di servizi aggiuntivi); art. 2.4 (esclusione dei soggiorni superiori a 30 "
  "giorni dall'oggetto del mandato); art. 2.5 (facoltà di subappalto e avvalimento di terzi); art. 3.2 "
  "(obblighi a carico dei Mandanti in solido); art. 3.3 (clausola risolutiva espressa in caso di "
  "cancellazione prenotazioni); art. 3.5 (esclusiva); art. 3.6 (conseguenze del mancato ottenimento del CIN, "
  "sospensione automatica dell'Annuncio e risoluzione ex art. 1456 c.c. decorsi 90 giorni); art. 3.8 "
  "(checklist di sicurezza all'onboarding ed efficacia probatoria); art. 4.2 (discrezionalità nei canali OTA); "
  "art. 4.4 (IBAN unico designato e riparto pro-quota estraneo al Contratto); art. 5.1, lett. a) (esonero "
  "dall'obbligo di consultazione preventiva); art. 5.2 (manleva dei Mandanti in solido, limitata ai fatti di "
  "propria sfera di controllo); art. 6 (limitazioni di responsabilità, cap risarcitorio non operante essendo "
  "i Mandanti consumatori; sistema integrato di copertura ex art. 6.4; registro di diligenza ex art. 6.5 con "
  ...
  "sempre dovuta sul corrispettivo netto); art. 7.3 (flusso pagamenti; regime consumatore per gli interessi "
  "di mora); art. 7.4 (responsabilità dei Mandanti per dichiarazione/versamento imposta di soggiorno e "
  "relativa manleva); art. 7.6 (channel manager a carico dei Mandanti dal 13° mese e facoltà alternative del "
  "Mandatario in caso di rifiuto); art. 7.7 (modifica della Quota soltanto per giustificato motivo, "
  "subordinata ad accettazione scritta di entrambi i Mandanti, e diritto di recesso senza penale); art. 8.1 "
  "(rinnovo automatico); art. 8.2-bis (penale di Euro 200,00 per recesso anticipato dei Mandanti entro 6 "
  "mesi, con esclusioni); art. 8.4 (clausole risolutive espresse); art. 10.2 (forma scritta ad substantiam); "
  "art. 11 (limiti alla cessione del Contratto); art. 13.1 (esclusione di rinuncia per inerzia); art. 17.2 "
  "(Foro di Como, fatto salvo l'art. 17.3 in materia di foro inderogabile del consumatore).")
...
p(doc,
  ...
  "Cernobbio; (iv) l'orientamento informativo sulla scelta del regime fiscale applicabile per ciascun "
  "Mandante pro-quota (cedolare secca 21%/26%; IRPEF ordinario; regime forfetario; regime IVA), tenuto "
  "conto della residenza fiscale svizzera del Mandante 2 e delle relative implicazioni ex art. 25 TUIR. "
  "Resta inteso che il Mandatario non sostituisce il commercialista dei Mandanti né presta consulenza "
  "fiscale qualificata, ma fornisce orientamento informativo e supporto operativo.")
...
p(doc,
  ...
  "(Responsabile del trattamento) per conto dei Mandanti (con-Titolari del trattamento ai sensi dell'art. 26 "
  "GDPR) nell'ambito dei Servizi del Contratto.")
...
p(doc,
  ...
  "dello Spazio Economico Europeo se non con garanzie adeguate. Le Parti danno atto che il Mandante 2 "
  "(Ephanie Sacramento) è residente in Svizzera, Paese che beneficia di decisione di adeguatezza della "
  "Commissione europea del 26/07/2000: eventuali trasferimenti di dati personali degli Ospiti verso il "
  "Mandante 2 (a titolo esemplificativo: report periodici, comunicazioni operative) sono coperti da tale "
